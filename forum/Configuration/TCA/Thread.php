	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_forum_domain_model_thread.pid=###CURRENT_PID### AND tx_forum_domain_model_thread.sys_language_uid IN (-1,0)',
			),
		),
		...
		'title' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:forum/Resources/Private/Language/locallang_db.xlf:tx_forum_domain_model_thread.title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
		...
		'posts' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:forum/Resources/Private/Language/locallang_db.xlf:tx_forum_domain_model_thread.posts',
			'config' => array(
				'type' => 'inline',
